    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 19, 12, 418);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-obcemg");
    			add_location(h2, file$2, 40, 4, 933);
    			attr_dev(div0, "bp", "grid");
    			add_location(div0, file$2, 39, 0, 913);
    			button.disabled = /*isRunning*/ ctx[1];
    			attr_dev(button, "bp", "offset-5@md 4@md 12@sm");
    			attr_dev(button, "class", "start svelte-obcemg");
    			add_location(button, file$2, 48, 4, 1076);
    			attr_dev(div1, "bp", "grid");
    			add_location(div1, file$2, 47, 0, 1056);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "Handwashing5.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "How to wash your hands");
    			attr_dev(img, "class", "svelte-c9l5rn");
    			add_location(img, file$1, 9, 4, 66);
    			attr_dev(div, "bp", "grid");
    			add_location(div, file$1, 8, 0, 46);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-14ue9g0");
    			add_location(h1, file, 16, 0, 205);
    			attr_dev(a0, "href", "http://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a0, file, 23, 1, 276);
    			attr_dev(a1, "href", "http://freesound.org/people/metrostock99/sounds/345086/");
    			add_location(a1, file, 27, 1, 363);
    			attr_dev(h3, "class", "svelte-14ue9g0");
    			add_location(h3, file, 22, 0, 270);
    			if (!src_url_equal(source.src, source_src_value = "sound.wav")) attr_dev(source, "src", source_src_value);
    			add_location(source, file, 33, 1, 485);
    			add_location(audio_1, file, 32, 0, 458);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
